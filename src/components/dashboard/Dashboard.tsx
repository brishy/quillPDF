...
const Page = ({ subscriptionPlan }: PageProps) => {
  ...
  return (
    <main className="mx-auto max-w-7xl p-4 md:p-10">
      <div className="mt-8 flex flex-col items-start justify-between gap-4 border-b border-gray-200 pb-5 sm:flex-row sm:items-center sm:gap-0">
        <h1 className="mb-3 font-heading text-5xl font-bold text-gray-900">
          My Files
        </h1>
      ...
      {files && files?.length !== 0 ? (
        <ul
          role="list"
          className="mt-8 grid grid-cols-1 flex-col gap-6 divide-y divide-zinc-200 md:grid-cols-2 lg:grid-cols-3"
        >
          {files
            .sort(
              (a, b) =>
